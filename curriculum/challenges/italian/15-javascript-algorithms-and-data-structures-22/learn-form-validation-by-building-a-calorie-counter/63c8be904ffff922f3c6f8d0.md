...
Ricordi che prima hai scritto una funzione per svuotare gli input dell'utente? Dovrai utilizzare quella funzione qui.
...
Dovresti assegnare il risultato della chiamata di `cleanInputString` alla variabile `currVal`.
