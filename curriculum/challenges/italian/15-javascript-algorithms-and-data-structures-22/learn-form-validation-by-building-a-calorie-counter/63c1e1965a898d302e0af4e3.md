...
JavaScript ha una funzionalità chiamata <dfn>template literal</dfn>, che consente di interpolare le variabili direttamente all'interno di una stringa. I template literal sono indicati con accenti gravi ` `` `, invece che tramite virgolette singole o doppie. Le variabili possono essere passate a un template literal racchiudendo la variabile in `${}` – il valore della variabile sarà inserito nella stringa.
