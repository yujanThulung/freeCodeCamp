...
Ricorda che in precedenza hai selezionato il menu a discesa nel codice JavaScript e lo hai assegnato al pulsante `entryDropdown`. You can use the <dfn>value</dfn> property to get the value of the selected option.
