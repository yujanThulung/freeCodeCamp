...
Desideri numerare le voci che l'utente aggiunge. To get all of the number inputs, you can use the <dfn>querySelectorAll()</dfn> method.
...
Dichiara una variabile `entryNumber` e dalle il valore di `targetInputContainer.querySelectorAll()`. Non devi ancora passare un argomento al selettore.
