...
Ora dichiara una variabile `remainingCalories` e dalle il valore della sottrazione di `consumedCalories` da `budgetCalories` con l'aggiunta di `exerciseCalories`.

# --hints--

La funzione `calculateCalories` dovrebbe avere una variabile `remainingCalories`.
...
Dovresti assegnare il valore di `budgetCalories - consumedCalories + exerciseCalories` a `remainingCalories`.
