...
# --description--
Strings have a <dfn>.match()</dfn> method, which takes a regex argument. `.match()` restituisce un array con i risultati trovati – contenente la prima corrispondenza o tutte, se viene usata l'opzione globale.
