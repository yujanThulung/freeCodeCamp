...
Il parametro `list` sarà il risultato di un selettore, che restituirà un `NodeList`. A `NodeList` is a list of elements like an array. It contains the elements that match the query selector. You will need to loop through these elements in the list.
