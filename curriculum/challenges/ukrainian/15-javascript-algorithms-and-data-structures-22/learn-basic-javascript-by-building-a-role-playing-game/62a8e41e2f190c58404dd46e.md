...
Ви повинні використати крапкову нотацію, щоб отримати доступ до властивості `innerText` об'єкта `text` в новому рядку.
...
Ви повинні використати складене присвоювання із `text.innerText`.
