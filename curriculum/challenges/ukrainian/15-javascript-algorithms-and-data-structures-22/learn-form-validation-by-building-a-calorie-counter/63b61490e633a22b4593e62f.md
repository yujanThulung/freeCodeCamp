...
Оголосіть змінну під назвою `addEntryButton`.

```js
assert.isDefined(addEntryButton);
```

Ви повинні використати `document.getElementById()`, щоб отримати елемент `#add-entry`.
...
Оголосіть змінну під назвою `clearButton`.

```js
assert.isDefined(clearButton);
```

Ви повинні використати `document.getElementById()`, щоб отримати елемент `#clear`.
...
Оголосіть змінну під назвою `output`.

```js
assert.isDefined(output);
```

Ви повинні використати `document.getElementById()`, щоб отримати елемент `#output`.
