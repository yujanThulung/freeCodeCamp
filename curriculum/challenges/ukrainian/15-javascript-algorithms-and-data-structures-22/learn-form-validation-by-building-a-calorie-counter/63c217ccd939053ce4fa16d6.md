...
Елемент `input` повинен мати атрибут `placeholder` зі значенням `Name`.
...
Елемент `input` повинен мати атрибут `id` зі значенням `${entryDropdown.value}-${entryNumber}-name`.
