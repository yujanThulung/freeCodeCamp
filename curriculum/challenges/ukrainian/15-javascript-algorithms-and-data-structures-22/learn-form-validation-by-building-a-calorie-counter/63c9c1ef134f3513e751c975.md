...
Функція `calculateCalories` повинна мати змінну `dinnerCalories`.
...
Функція `calculateCalories` повинна мати змінну `snacksCalories`.
...
Функція `calculateCalories` повинна мати змінну `exerciseCalories`.
