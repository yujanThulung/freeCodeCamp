...
Você pode acessar as propriedades em JavaScript de algumas maneiras diferentes. A primeira é com a <dfn>notação de ponto</dfn>. Here is an example of using dot notation to set the `onclick` property of a button to a function reference.
