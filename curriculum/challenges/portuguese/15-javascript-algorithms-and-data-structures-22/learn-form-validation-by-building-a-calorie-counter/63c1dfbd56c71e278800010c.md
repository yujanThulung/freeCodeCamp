...
Lembre-se de que você já consultou a lista suspensa antes no JavaScript e a atribuiu ao botão `entryDropdown`. You can use the <dfn>value</dfn> property to get the value of the selected option.
