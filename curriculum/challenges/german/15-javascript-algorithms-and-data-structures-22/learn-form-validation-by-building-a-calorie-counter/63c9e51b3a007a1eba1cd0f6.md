...
Deklariere nun eine `remainingCalories`-Variable und weise ihr den Wert zu, der sich aus der Subtraktion von `consumedCalories` von `budgetCalories` und der Addition von `exerciseCalories` ergibt.
