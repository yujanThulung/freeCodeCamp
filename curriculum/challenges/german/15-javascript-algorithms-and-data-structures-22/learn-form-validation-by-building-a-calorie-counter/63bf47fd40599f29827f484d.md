...
The pattern you currently have will match the exact text `hello`, which is not what you want to match. Du möchtest nach `+`, `-` oder Leerzeichen suchen. Replace the pattern in your `regex` variable with `\+-` to look for plus and minus characters.
