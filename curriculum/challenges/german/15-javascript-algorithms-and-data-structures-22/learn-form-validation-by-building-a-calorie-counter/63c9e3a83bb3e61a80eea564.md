...
You also need to get the value of your `#budget` input. Du hast dies bereits am Anfang deines Codes abgefragt und auf die `budgetNumberInput`-Variable gesetzt. However, you used `getElementById`, which returns an `Element`, not a `NodeList`.
