...
Versuche, der `Breakfast`-Kategorie ein paar Einträge hinzuzufügen, und du könntest einige Fehler entdecken! The first thing we need to fix is the entry counts – the first entry should have a count of `1`, not `0`.
